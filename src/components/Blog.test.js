...
describe('rendering a Blog component', () => {
  ...
  beforeEach(() => {
    container = render(<Blog blog={blog} handleVisibility={mockVisibility} handleLike={mockLikes} />).container
  })
  ...
  test('more details are shown after button click', async () => {
    ...
    expect(titleAndAuthorDiv).toHaveTextContent('Testaus, koodauksen lyijyisin vaihe Testi-Tero')
